...
public class Photo {
    ...
    @NotNull
    @Positive
    // Migrated from Oracle to PostgreSQL according to Java check item 1: Convert column definitions to PostgreSQL types.
     ...
     */
    @NotNull
    // Migrated from Oracle to PostgreSQL according to Java check item 1: Convert column definitions to PostgreSQL types (SYSTIMESTAMP → CURRENT_TIMESTAMP).
