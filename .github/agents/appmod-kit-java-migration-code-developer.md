...
mcp-servers: 
  java-migration:
    ...
    tools: ['appmod-completeness-validation','appmod-consistency-validation', 'appmod-create-migration-summary','appmod-fetch-knowledgebase','appmod-run-task','appmod-search-file','appmod-search-knowledgebase','appmod-version-control','validate_cves_for_java','build_java_project','run_tests_for_java','list_jdks', 'list_mavens', 'install_jdk', 'install_maven']
    env:
